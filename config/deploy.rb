...
set :linked_files, fetch(:linked_files, []).push('config/database.yml', 'config/secrets.yml', 'config/config.yml', 'config/seed_data.yml', 'config/unicorn.rb', 'public/sitemap.xml')
